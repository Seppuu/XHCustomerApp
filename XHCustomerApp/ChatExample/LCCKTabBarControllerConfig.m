...
#import "XHCustomerApp-Swift.h"

@interface LCCKTabBarControllerConfig ()

@property (nonatomic, readwrite, strong) CYLTabBarController *tabBarController;
@property (nonatomic, strong) RecommendVC *firstViewController;
@property (nonatomic, strong) OrderViewController *secondViewController;
